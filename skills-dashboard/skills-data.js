// 自动生成于 2026/6/8 22:51:57
// 运行 node generate-skills-data.js 重新生成
// 请勿手动编辑此文件
window.__SKILLS_DATA__ = {
  "generatedAt": "2026-06-08T14:51:57.718Z",
  "totals": {
    "all": 107,
    "global": 99,
    "project": 0,
  ...
  "skills": [
    ...
    {
      "name": "data-update",
      "description": "数据更新工作流——运行数据生成脚本、Git 提交推送、同步双分支（master + dev）、确认 GitHub Pages 部署。当用户说\"数据更新\"、\"更新数据\"、\"刷新数据\"、\"更新报告\"、\"数据刷新\"时触发。也适用于\"更新到最新\"、\"跑一下数据\"、\"刷新一下报告\"等变体。",
      "source": "Anthropic",
      "category": "其他",
      "dimensions": {
        "scenario": "数据更新工作流——运行数据生成脚本、Git 提交推送、同步双分支（master + dev）、确认 GitHub Pages 部署。",
        "trigger": "数据更新工作流——运行数据生成脚本、Git 提交推送、同步双分支（master + dev）、确认 GitHub Pages 部署。当用户说\"数据更新\"、\"更新数据\"、\"刷新数据\"、\"更新报告\"、\"数据刷新\"时触发",
        "features": "数据更新工作流——运行数据生成脚本、Git 提交推送、同步双分支（master + dev）、确认 GitHub Pages 部署。当用户说\"数据更新\"、\"更新数据\"、\"刷新数据\"、\"更新报告\"、\"数据刷新\"时触发。也适用于\"更新到最新\"、\"跑一下数据\"、\"刷新一下报告\"等变体。",
        "solves": "提升效率，减少手动操作和查找文档的时间。",
        "steps": [
          "读取技能文档",
          "按文档执行操作",
    ...
    },
    {
      ...
      "category": "其他",
      "dimensions": {
        "scenario": "通过小云雀的 AI 能力进行综合创作，支持生成和编辑图片/视频。",
        "trigger": "通过小云雀的 AI 能力进行综合创作，支持生成和编辑图片/视频。覆盖场景包括：生成（文生图、文生视频、图生视频、做动画、画一个xxx、来段xxx）、编辑修改（把xxx换成yyy、去掉xxx、加上xxx、改成xxx、调整xxx、局部修改、改镜头）、风格转换（风格迁移、转绘、换风格）、视频续写延长、复刻视频/TVC/宣传片、短剧/短漫剧生成、音乐MV生成、产品广告/展示片制作、分镜/故事板设计、教育视频/短视频制作",
        "features": "通过小云雀的 AI 能力进行综合创作，支持生成和编辑图片/视频。覆盖场景包括：生成（文生图、文生视频、图生视频、做动画、画一个xxx、来段xxx）、编辑修改（把xxx换成yyy、去掉xxx、加上xxx、改成xxx、调整xxx、局部修改、改镜头）、风格转换（风格迁移、转绘、换风格）、视频续写延长、复刻视频/TVC/宣传片、短剧/短漫剧生成、音乐MV生成、产品广告/展示片制作、分镜/故事板设计、教育视频/短视频制作。当用户提到小云雀、xyq、上传参考图/视频、查看生成进度时也应触发。关键判断：只要用户的请求涉及 AI 视频的创作、生成、编辑、修改，无论措辞如何（如\"画只猫\"、\"做个海报\"、\"做个视频\"、\"这个视频帮我改一下\"、\"帮我复刻这段视频\"、\"用这首歌做个MV\"、\"一句话生成短剧\"），都必须触发此技能。",
        "solves": "提升效率，减少手动操作和查找文档的时间。",
        "steps": [
          "读取技能文档",
          "按文档执行操作",
